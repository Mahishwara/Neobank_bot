...
public class AuthenticationService {
    ...
    private final RemoteNeobankService remoteNeobankService;
    ...
    @Autowired
    public AuthenticationService(RemoteNeobankService remoteNeobankService,
                                 ApplicationConfig applicationConfig,
                                 HashGenerator hashGenerator) {
        this.remoteNeobankService = remoteNeobankService;
    ...
    public Authentication getAuthentication(Long chatId, User user) {
        ...
        String bearerToken = remoteNeobankService.getToken(params);
